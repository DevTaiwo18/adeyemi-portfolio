...
export const experiences = [
  ...
  },
  {
    ...
    description:
      "Building and maintaining a full-stack estate sales platform serving 100+ active users including agents, clients, and vendors.",
    highlights: [
      "Serving 100+ active users across 3 roles (agents, clients, vendors) on a live production platform",
      "Built full e-commerce marketplace processing real Stripe transactions with cart, checkout, and order management",
      "Achieved 92/100 Google PageSpeed score through image compression, code splitting, and database indexing",
      "Integrated AI-powered item cataloging, reducing manual inventory entry time by an estimated 60%",
      "Passed OWASP security checklist with CSP headers, HSTS, and input sanitization across all endpoints",
      "Deployed and managed production infrastructure across 2 platforms (Vercel and Render) with zero downtime launches",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Delivered 10+ client projects across fintech, e-commerce, and event management domains",
      "Built and deployed full-stack applications with average turnaround of under 2 weeks per project",
      "Integrated payment systems (Paystack, Stripe) across multiple client platforms handling real transactions",
      "Maintained 5-star client satisfaction by translating requirements into clean, documented codebases",
    ],
